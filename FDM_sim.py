"""
╔══════════════════════════════════════════════════════════════╗
║  AIRCRAFT FDM — ALL 4 CONDITIONS  (LIVE SIMULATION)         ║
║  Real-time playback of flight data, minute by minute        ║
║                                                              ║
║  Run:  streamlit run fdm_simulation.py                       ║
...
# ─────────────────────────────────────────────────────────────
#  SIMULATION DATA  (all 30 points pre-generated)
# ─────────────────────────────────────────────────────────────
np.random.seed(42)
DURATION = 30
